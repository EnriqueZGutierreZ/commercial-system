...
public class OrdenCompraViewBACKUP extends Div {
    ...
    //constructor
    public OrdenCompraViewBACKUP(OrdenCompraService ordenCompraService, OrdenCompraDetService ordenCompraDetService, ProductoService productoService, AlmacenService almacenService) {
